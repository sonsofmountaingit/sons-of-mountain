...
- Name: cms-revalidation.spec.ts >> CMS → Frontend Revalidation >> program detail page renders immediately (force-dynamic)
- Location: tests/e2e/cms-revalidation.spec.ts:184:7
