...
- Name: checkout-customer-linking.spec.ts >> Checkout ties purchases/bookings to customer account >> anonymous cart checkout does not link any customer
- Location: tests/e2e/checkout-customer-linking.spec.ts:64:7
