...
- Name: cms-revalidation.spec.ts >> CMS → Frontend Revalidation >> Hero global: save via Payload API → homepage still serves (cache busted)
- Location: tests/e2e/cms-revalidation.spec.ts:327:7
...
Expected substring: "E2E Hero Test 1781004889494"
