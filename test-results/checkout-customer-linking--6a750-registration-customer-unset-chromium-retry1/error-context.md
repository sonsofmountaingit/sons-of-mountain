...
- Name: checkout-customer-linking.spec.ts >> Checkout ties purchases/bookings to customer account >> anonymous booking leaves registration.customer unset
- Location: tests/e2e/checkout-customer-linking.spec.ts:153:7
