...
const VARIABLES: { name: string; label: string }[] = [
  ...
  { name: 'offeringTitle', label: 'Voucher Offering Title (or all adventures)' },
  { name: 'offeringUrl', label: 'Voucher Offering Direct Link' },
  { name: 'offeringType', label: 'Voucher Offering Type (destination/trip/program/all)' },
