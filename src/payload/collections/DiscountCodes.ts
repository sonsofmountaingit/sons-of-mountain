...
export const DiscountCodes: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        { label: 'All', value: 'all' },
        { label: 'All Trips', value: 'trips' },
        { label: 'All Products', value: 'products' },
        { label: 'All Programs', value: 'programs' },
        { label: 'All Destinations', value: 'destinations' },
        { label: 'Specific Trip', value: 'specific-trip' },
        { label: 'Specific Program', value: 'specific-program' },
        { label: 'Specific Destination', value: 'specific-destination' },
      ],
      defaultValue: 'all',
      admin: { position: 'sidebar' },
    },
    {
      ...
      type: 'relationship',
      relationTo: 'trips',
      admin: { position: 'sidebar', condition: (data) => data.applicableTo === 'specific-trip' },
    },
    {
      name: 'specificProgram',
      type: 'relationship',
      relationTo: 'programs',
      admin: { position: 'sidebar', condition: (data) => data.applicableTo === 'specific-program' },
    },
    {
      name: 'specificDestination',
      type: 'relationship',
      relationTo: 'destinations',
      admin: { position: 'sidebar', condition: (data) => data.applicableTo === 'specific-destination' },
    },
    {
      name: 'bundleItems',
      type: 'array',
