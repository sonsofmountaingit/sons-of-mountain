...
async function seed() {
  ...
  const destData: any = {
    ...
    faq: [
      ...
      { question: 'Какви документи са ни необходими?', answer: richText('Необходим е международен паспорт, валиден минимум 6 месеца след датата на завръщане. Виза се издава на летището (Visa on Arrival) за €50.') },
      { question: 'Каква е валутата и колко пари трябва да нося?', answer: richText('Официалната валута е угандийски шилинг (UGX). Препоръчваме около €300-400 за лични разходи, бакшиши и сувенири.') },
