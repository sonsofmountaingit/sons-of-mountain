...
const TRIPS_DATA = [
  // Bulgaria
  { title: 'Седемте рилски езера', destSlug: 'rila', startDate: '2026-07-10', endDate: '2026-07-14', price: 490, currency: 'EUR', spotsTotal: 14, tags: ['Adventure', 'Family'] },
  { title: 'Черния връх зимен поход', destSlug: 'rila', startDate: '2026-01-15', endDate: '2026-01-18', price: 350, currency: 'EUR', spotsTotal: 10, tags: ['Adventure', 'Singles Only'] },
  { title: 'Вихрен и Синаница', destSlug: 'pirin', startDate: '2026-08-20', endDate: '2026-08-24', price: 550, currency: 'EUR', spotsTotal: 12, tags: ['Adventure'] },
  { title: 'Пирин есенен поход', destSlug: 'pirin', startDate: '2026-10-03', endDate: '2026-10-06', price: 420, currency: 'EUR', spotsTotal: 12, tags: ['Adventure', 'Cultural'] },
  { title: 'Ягодинска пещера и Триград', destSlug: 'rhodopes', startDate: '2026-05-08', endDate: '2026-05-10', price: 280, currency: 'EUR', spotsTotal: 16, tags: ['Cultural', 'Family'] },
  { title: 'Родопска приказка', destSlug: 'rhodopes', startDate: '2026-09-18', endDate: '2026-09-21', price: 390, currency: 'EUR', spotsTotal: 14, tags: ['Cultural'] },
  // Abroad
