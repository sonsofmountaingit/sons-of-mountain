...
// ---------------------------------------------------------------------------
const TRIP_DATA = [
  { title: 'Седемте рилски езера', destSlug: 'rila', startDate: '2026-07-10', endDate: '2026-07-14', price: 490, currency: 'EUR', spotsTotal: 14, tags: ['Adventure', 'Family'], depositAmount: 100 },
  { title: 'Черния връх зимен поход', destSlug: 'rila', startDate: '2027-01-15', endDate: '2027-01-18', price: 350, currency: 'EUR', spotsTotal: 10, tags: ['Adventure', 'Singles Only'], depositAmount: 80 },
  { title: 'Вихрен и Синаница', destSlug: 'pirin', startDate: '2026-08-20', endDate: '2026-08-24', price: 550, currency: 'EUR', spotsTotal: 12, tags: ['Adventure'], depositAmount: 120 },
  { title: 'Пирин есенен поход', destSlug: 'pirin', startDate: '2026-10-03', endDate: '2026-10-06', price: 420, currency: 'EUR', spotsTotal: 12, tags: ['Adventure', 'Cultural'], depositAmount: 100 },
  { title: 'Ягодинска пещера и Триград', destSlug: 'rhodopes', startDate: '2026-05-08', endDate: '2026-05-10', price: 280, currency: 'EUR', spotsTotal: 16, tags: ['Cultural', 'Family'], depositAmount: 70 },
  { title: 'Родопска приказка', destSlug: 'rhodopes', startDate: '2026-09-18', endDate: '2026-09-21', price: 390, currency: 'EUR', spotsTotal: 14, tags: ['Cultural'], depositAmount: 90 },
  { title: 'Ком–Емине: 700 км пеш', destSlug: 'balkan-mountains', startDate: '2026-06-01', endDate: '2026-06-15', price: 1290, currency: 'EUR', spotsTotal: 10, tags: ['Adventure', 'Adventure'], depositAmount: 250 },
  { title: 'Витоша с деца', destSlug: 'vitosha', startDate: '2026-07-04', endDate: '2026-07-05', price: 120, currency: 'EUR', spotsTotal: 20, tags: ['Family'], depositAmount: 30 },
...
const PROG_DATA = [
  ...
  { title: 'Ски уикенд в Банско', slug: 'ski-bansko-2026', type: 'Ski', shortDescription: 'Четири дни ски и сноуборд в Банско.', location: 'Банско, България', startDate: '2027-01-22', endDate: '2027-01-26', price: 590, currency: 'EUR', spotsTotal: 16, tags: ['Ski', 'Family'], heroImageUrl: 'https://images.pexels.com/photos/848618/pexels-photo-848618.jpeg?auto=compress&cs=tinysrgb&w=1200', instructor: { name: 'Тодор Маринов', bio: 'Ски инструктор ниво 3.' }, latitude: 41.83, longitude: 23.49, durationDays: 4 },
  { title: 'Фотографски уъркшоп – Пловдив', slug: 'photography-plovdiv-2026', type: 'Photography', shortDescription: 'Уъркшоп по пейзажна и улична фотография в Пловдив.', location: 'Пловдив, България', startDate: '2026-04-18', endDate: '2026-04-20', price: 320, currency: 'EUR', spotsTotal: 10, tags: ['Photography', 'Cultural'], heroImageUrl: 'https://images.pexels.com/photos/1707820/pexels-photo-1707820.jpeg?auto=compress&cs=tinysrgb&w=1200', instructor: { name: 'Георги Василев', bio: 'Пейзажен фотограф, публикуван in National Geographic.' }, latitude: 42.15, longitude: 24.75, durationDays: 2 },
  ...
  { title: 'Ски туризъм – Пирин', slug: 'ski-tour-pirin-2027', type: 'Ski', shortDescription: 'Три дни ски туризъм в дивата природа на Пирин.', location: 'Банско, България', startDate: '2027-02-05', endDate: '2027-02-08', price: 450, currency: 'EUR', spotsTotal: 8, tags: ['Ski', 'Adventure'], heroImageUrl: 'https://images.pexels.com/photos/1271619/pexels-photo-1271619.jpeg?auto=compress&cs=tinysrgb&w=1200', instructor: { name: 'Тодор Маринов', bio: 'Ски инструктор ниво 3.' }, latitude: 41.79, longitude: 23.47, durationDays: 3 },
  ...
  { title: 'Бърд уотчинг – Странджа', slug: 'birdwatching-strandzha-2026', type: 'Adventure', shortDescription: 'Четири дни наблюдение на птици в биосферен резерват Странджа.', location: 'Малко Търново, България', startDate: '2026-05-01', endDate: '2026-05-05', price: 320, currency: 'EUR', spotsTotal: 12, tags: ['Adventure'], heroImageUrl: 'https://images.pexels.com/photos/349758/pexels-photo-349758.jpeg?auto=compress&cs=tinysrgb&w=1200', instructor: { name: 'Боян Тенев', bio: 'Еколог и бърд уотчинг водач.' }, latitude: 41.97, longitude: 27.53, durationDays: 4 },
  { title: 'Рафтинг – Арда', slug: 'rafting-arda-2026', type: 'Adventure', shortDescription: 'Два дни рафтинг по река Арда в сърцето на Родопите.', location: 'Кърджали, България', startDate: '2026-06-27', endDate: '2026-06-28', price: 180, currency: 'EUR', spotsTotal: 16, tags: ['Adventure', 'Adventure'], heroImageUrl: 'https://images.pexels.com/photos/2304647/pexels-photo-2304647.jpeg?auto=compress&cs=tinysrgb&w=1200', instructor: { name: 'Мила Събева', bio: 'Каяк и рафтинг инструктор.' }, latitude: 41.64, longitude: 25.37, durationDays: 2 },
...
// ---------------------------------------------------------------------------
const VOUCHER_DATA = [
  { code: 'GIFT-100-EUR', recipientName: 'Иван Петров', recipientEmail: 'ivan.petrov@example.com', amount: 100, currency: 'EUR', senderName: 'Мария Иванова', message: 'Честит рожден ден!' },
  { code: 'GIFT-200-EUR', recipientName: 'Анна Тодорова', recipientEmail: 'anna.todorova@example.com', amount: 200, currency: 'EUR', senderName: 'Петър Стоянов', message: 'За твоето следващо приключение.' },
  ...
  { code: 'GIFT-300-EUR', recipientName: 'Николай Попов', recipientEmail: 'nikolai.popov@example.com', amount: 300, currency: 'EUR', senderName: 'Офисът', message: 'За твоята почивка — заслужено!' },
  { code: 'GIFT-500-EUR', recipientName: 'Елена Маринова', recipientEmail: 'elena.marinova@example.com', amount: 500, currency: 'EUR', senderName: 'Кристиан Петров', message: 'Честита годишнина!' },
  ...
  { code: 'GIFT-400-EUR', recipientName: 'Мила Тодорова', recipientEmail: 'mila.todorova@example.com', amount: 400, currency: 'EUR', senderName: 'Братя и сестри', message: 'Обичаме те!' },
  ...
  { code: 'GIFT-220-EUR', recipientName: 'Десислава Петрова', recipientEmail: 'desi.petrova@example.com', amount: 220, currency: 'EUR', senderName: 'Иван Петров', message: 'За теб, скъпа.' },
  { code: 'GIFT-350-EUR', recipientName: 'Боян Стоилов', recipientEmail: 'boyan.stoilov@example.com', amount: 350, currency: 'EUR', senderName: 'Клуб планинари', message: 'Продължавай да изкачваш!' },
  ...
  { code: 'GIFT-600-EUR', recipientName: 'Стефан Георгиев', recipientEmail: 'stefan.georgiev@example.com', amount: 600, currency: 'EUR', senderName: 'Семейство', message: 'Честит Нова Година!' },
  ...
  { code: 'GIFT-280-EUR', recipientName: 'Радослав Ненов', recipientEmail: 'rado.nenov@example.com', amount: 280, currency: 'EUR', senderName: 'Мария Ненова', message: 'Зарежи се с природа!' },
  ...
  { code: 'GIFT-90-EUR', recipientName: 'Кирил Данаилов', recipientEmail: 'kiril.danailov@example.com', amount: 90, currency: 'EUR', senderName: 'Братовчед', message: 'Хайде, давай!' },
  ...
  { code: 'GIFT-130-EUR', recipientName: 'Яна Тодорова', recipientEmail: 'yana.todorova@example.com', amount: 130, currency: 'EUR', senderName: 'Приятели', message: 'Приключения без край!' },
  { code: 'GIFT-320-EUR', recipientName: 'Пламен Христов', recipientEmail: 'plamen.hristov@example.com', amount: 320, currency: 'EUR', senderName: 'Семейство', message: 'Честит Свети Валентин!' },
]
