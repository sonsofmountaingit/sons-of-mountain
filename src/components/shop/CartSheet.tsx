  ...
  return (
    <>
      ...
      <div
        ...
        aria-label={t.shop.cart_heading}
      >
        <div className="flex items-center justify-between border-b px-6 py-4">
          <h2 className="text-lg font-semibold">{t.shop.cart_heading} ({cartHydrated ? itemCount() : 0})</h2>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-900" aria-label={t.shop.close_cart}>
        ...
        <div className="flex-1 overflow-y-auto px-6 divide-y">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full gap-4 text-gray-400">
              ...
              <p className="text-sm">{t.shop.cart_empty}</p>
            </div>
          ) : (
