...
export function FooterBlockRenderer({ overrides }: Props = {}) {
  ...
  const copyright = d.copyright ?? '© 2018-2026 Сонс оф Маунтин'
  const licenseText = d.licenseText ?? 'Номер на лиценз: '
  const insuranceText = d.insuranceText ?? 'Номер на застрахователна полица: '
