        ...
        <nav className="w-full px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 flex-1 justify-end">
            ...
            <div className="flex items-center gap-4 ml-4 border-l border-white/20 pl-4">
              ...
              <a
                href="https://instagram.com/sonsofmountains"
                target="_blank"
              ...
              <a
                href="https://facebook.com/sonsofmountains"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/80 hover:text-white transition-colors"
                aria-label="Facebook"
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-6 px-6 mt-auto pb-12">
              <a href="https://instagram.com/sonsofmountains" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white">
              ...
              <a href="https://facebook.com/sonsofmountains" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white">
