...
export async function PATCH(request: Request) {
  ...
  const hero = get('CalendarHeroBlock')
  ...
  await payload.updateGlobal({ slug: 'calendar-page', data: updateData, overrideAccess: true }).catch(() => {})
  ;(revalidateTag as any)('calendar-page', 'max')
