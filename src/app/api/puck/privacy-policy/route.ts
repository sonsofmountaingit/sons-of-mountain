...
export async function PATCH(request: Request) {
  ...
  const block = get('PrivacyPolicyContentBlock')
  ...
  await payload.updateGlobal({ slug: 'privacy-policy', data: updateData, overrideAccess: true }).catch(() => {})

  ;(revalidateTag as any)('privacy-policy', 'max')
