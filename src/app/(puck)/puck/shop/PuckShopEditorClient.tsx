...
const EMPTY_DATA: Data = {
  content: [{ type: 'ShopHeroBlock', props: { id: 'shop-hero' } }],
  root: { props: {} },
}

export function PuckShopEditorClient({ initialData }: { initialData: Data }) {
  ...
  const handleAction = useCallback((action: { type: string }, appState: { data: Data }) => {
    ...
    autosaveTimer.current = setTimeout(() => {
      saveShopPuckData(appState.data).catch(() => {})
  ...
  return (
    <Puck
      ...
      headerTitle={saving ? 'Shop — Saving…' : 'Shop'}
      headerPath="/admin/globals/shop"
