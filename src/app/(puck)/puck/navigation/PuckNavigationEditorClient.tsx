...
export function PuckNavigationEditorClient({ initialData }: { initialData: Data }) {
  ...
  const handleAction = useCallback((action: { type: string }, appState: { data: Data }) => {
    ...
    autosaveTimer.current = setTimeout(() => {
      saveNavigationPuckData(appState.data).catch(() => {})
  ...
  return (
    <Puck
      ...
      headerTitle={saving ? 'Navigation — Saving…' : 'Navigation'}
      headerPath="/admin/globals/navigation"
