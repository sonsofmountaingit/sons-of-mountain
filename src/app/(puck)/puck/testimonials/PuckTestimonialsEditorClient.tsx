...
export function PuckTestimonialsEditorClient({ initialData }: { initialData: Data }) {
  ...
  return (
    <Puck
      ...
      headerTitle={saving ? 'Testimonials — Saving…' : 'Testimonials'}
      headerPath="/admin/globals/testimonials-section"
      ...
      overrides={{
        ...
        headerActions: ({ children }) => (
          <>
            <a href="/admin/globals/testimonials-section" style={{ display: 'inline-flex', alignItems: 'center', gap: 4, padding: '5px 10px', fontSize: 12, color: 'inherit', textDecoration: 'none', borderRadius: 4, border: '1px solid rgba(0,0,0,0.18)', marginRight: 6, opacity: 0.75 }}>
              ← Admin
            </a>
            {children}
          </>
