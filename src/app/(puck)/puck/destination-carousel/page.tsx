        ...
        content: c.puckData.content.map((block: any) =>
          block.type === 'HomeDestCarouselBlock'
            ? {
                ...
                props: {
                  ...block.props,
                  headline: block.props.headline ?? c?.headline ?? 'Hikes, journeys, and expeditions in Bulgaria and around the world!',
                  subheading: block.props.subheading ?? c?.subheading ?? 'Travel with Sons of Mountains where comfort meets adventure.',
                  ...
                  introSlideButtonText: block.props.introSlideButtonText ?? c?.introSlideButtonText ?? 'Explore',
        ...
        content: [
          {
            ...
            props: {
              ...
              sectionTitle: c?.sectionTitle ?? 'Destinations',
