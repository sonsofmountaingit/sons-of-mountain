...
async function saveData(data: Data): Promise<boolean> {
  const res = await fetch('/api/puck/terms-and-conditions', {
    method: 'PATCH',
...
export function PuckTermsAndConditionsEditorClient({ initialData }: { initialData: Data }) {
  ...
  return (
    <Puck
      ...
      headerTitle={saving ? 'Общи условия — Saving…' : 'Общи условия'}
      headerPath="/admin/globals/terms-and-conditions"
      ...
      overrides={{
        ...
        headerActions: ({ children }) => (
          <>
            <a
              href="/admin/globals/terms-and-conditions"
