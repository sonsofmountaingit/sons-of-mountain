...
export async function generateMetadata(): Promise<Metadata> {
  return buildStaticMetadata('/shop/gift-vouchers', {
  ...
  async () => {
    try {
      ...
      const [destinations, trips, programs] = await Promise.all([
        payload.find({ collection: 'destinations', where: { bookingStatus: { not_equals: 'archived' }, _status: { equals: 'published' } }, limit: 20, depth: 0, overrideAccess: true }),
