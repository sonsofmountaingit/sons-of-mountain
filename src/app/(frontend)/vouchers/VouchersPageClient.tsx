...
export const VOUCHERS_DEFAULTS = {
  ...
  subtext: 'Подари приключение, което ще остане за цял живот. Ваучерът може да бъде използван за всеки наш преход, експедиция или продукт.',
  buyTabLabel: 'Купи ваучер',
  redeemTabLabel: 'Въведи ваучер',
  mineTabLabel: 'Моите ваучери',
  forMyselfLabel: 'За мен',
  giftSomeoneLabel: 'За подарък',
  chooseAmountLabel: 'Избери сума',
  amountPresets: [{ amount: 50 }, { amount: 100 }, { amount: 200 }, { amount: 300 }, { amount: 500 }],
  customAmountLabel: 'Въведи сума',
  customAmountPlaceholder: 'Въведи сума (€)',
  minAmount: 1,
  maxAmount: 5000,
  minAmountError: 'Минимум €1',
  maxAmountError: 'Максимум €5000',
  forSpecificLabel: 'Избери за:',
  openTypeLabel: 'ЗА ВСЕКИ ПРЕХОД',
  destinationTypeLabel: 'В БЪЛГАРИЯ',
  tripTypeLabel: 'В ЧУЖБИНА',
  programTypeLabel: 'ПРОГРАМА',
  selectDestinationLabel: 'Избери програма в България',
  selectTripLabel: 'Избери програма в чужбина',
  selectProgramLabel: 'Избери програма',
  selectedProgramPrefix: 'Този ваучер е за',
  recipientDetailsLabel: 'Данни на получателя',
  recipientNamePlaceholder: 'Име на получателя',
  recipientEmailPlaceholder: 'Имейл на получателя',
  recipientNameRequiredError: 'Задължително поле',
  recipientEmailInvalidError: 'Невалиден имейл',
  personalMessageLabel: 'Лично послание',
  giftMessagePlaceholder: 'Напишете лично послание към получателя (по желание)',
  selfMessagePlaceholder: 'Послание за този ваучер (по желание)',
  scheduleDeliveryLabel: 'Ваучерът ще бъде изпратен по имейл на избраната от теб дата:',
  sendTodayLabel: 'Изпрати сега',
  signedInAsPrefix: 'Активен профил',
  signInPromptText: 'Остава само една стъпка - влезте в профила си или създайте нов.',
  submitLoadingLabel: 'Пренасочване...',
  submitButtonPrefix: 'Купи',
  submitButtonSuffix: 'Ваучер',
  voucherCreateError: 'Грешка при създаване на ваучера',
  genericError: 'Възникна грешка',
  giftDescriptionPrefix: 'Подаръчен ваучер за',
  selfDescriptionPrefix: 'Приключенски ваучер',
  redeemPromptLabel: 'Въведи кода на своя ваучер',
  redeemCodePlaceholder: 'SOM-XXXX-XXXX',
  redeemButtonLabel: 'Използвай своя ваучер',
  redeemLoadingLabel: '...',
  redeemSuccessPrefix: 'Ваучерът е използван. Стойност:',
  redeemGenericError: 'Възникна грешка',
  redeemSignInPrefix: 'Влез в профила си',
  redeemSignInSuffix: 'за да използваш ваучера.',
  mineSignInPrompt: 'Влез в профила си за да видиш ваучерите си',
  mineSignInButtonLabel: 'Влез в профила си',
  mineEmptyLabel: 'Все още нямате ваучери',
  mineGiftBadgeLabel: 'Подарък',
  mineForPrefix: 'За:',
  mineExpiresPrefix: 'Крайна дата',
  statusActiveLabel: 'Активен',
  statusRedeemedLabel: 'Използван',
  statusExpiredLabel: 'Изтекъл',
  statusCancelledLabel: 'Отказан',
}
