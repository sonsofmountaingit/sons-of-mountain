  ...
  components: {
    ...
    AboutWhoWeAreBlock: {
      ...
      fields: {
        ...
        whoImage1Caption: { type: 'text', label: 'Photo 1 Caption' },
        whoImage1Instagram: { type: 'text', label: 'Photo 1 Instagram handle' },
        whoImage2Url: { type: 'text', label: 'Photo 2 URL' },
        whoImage2Caption: { type: 'text', label: 'Photo 2 Caption' },
        whoImage2Instagram: { type: 'text', label: 'Photo 2 Instagram handle' },
      },
      defaultProps: {
